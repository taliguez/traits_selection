####Gam models for trees in Atlantic forest, making the plots
...
sr<-rast("eco_based_AF/SR_AF.grd")
pd<-rast("eco_based_AF/PD_AF.grd")
MPD<-rast("eco_based_AF/MPD_AF.grd")

##### FDR ~ SR #####
###### Eco based - fdr ~ sr ######### 
fdr<-rast("eco_based_AF/fdr_AF_ecobased.grd")
raoq<-rast("eco_based_AF/RaoQ_AF_ecobased.grd")
...
###### PCA - fdr ~ sr ###### 
fdr_PCA<-rast("pca/fdr_AF_pca.grd")
raoq_PCA<-rast("pca/RaoQ_AF_pca.grd")
...
fdr_within_clusters<-rast("within_clusters/fdr_AF_within_clusters.grd")
raoq_within_clusters<-rast("within_clusters/RaoQ_AF_within_clusters.grd")
...
for (i in 1:10){
  #download data
  fdr_random<-rast(paste0("random", i, "/fdr_AF_random", i, ".grd"))
  raoq_random<-rast(paste0("random", i, "/RaoQ_AF_random", i, ".grd"))
...
#all - no subset, (not (0;0) at the origin/not (0;0) at the origin)
g <- ggplot()+
  #eco_based
  geom_point(data=stackRas, aes(x=sr, y=fdr, color="Ecologically based"), alpha=0.06) +
  geom_smooth(data=pred_data, aes(x=sr, y=fit, color="Ecologically based")) +
  
  #random 1
  geom_point(data=stackRas_list$stackRas_random1, aes(x=sr, y=fdr, color="Random 1"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random1, aes(x=sr, y=fit, color="Random 1")) +
  
  #random 2
  geom_point(data=stackRas_list$stackRas_random2, aes(x=sr, y=fdr, color="Random 2"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random2, aes(x=sr, y=fit, color="Random 2")) +
  
  #random 3
  geom_point(data=stackRas_list$stackRas_random3, aes(x=sr, y=fdr, color="Random 3"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random3, aes(x=sr, y=fit, color="Random 3")) +
  
  #random 4
  geom_point(data=stackRas_list$stackRas_random4, aes(x=sr, y=fdr, color="Random 4"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random4, aes(x=sr, y=fit, color="Random 4")) +
  
  #random 5
  geom_point(data=stackRas_list$stackRas_random5, aes(x=sr, y=fdr, color="Random 5"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random5, aes(x=sr, y=fit, color="Random 5")) +
  
  #random 6
  geom_point(data=stackRas_list$stackRas_random6, aes(x=sr, y=fdr, color="Random 6"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random6, aes(x=sr, y=fit, color="Random 6")) +
  
  #random 7
  geom_point(data=stackRas_list$stackRas_random7, aes(x=sr, y=fdr, color="Random 7"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random7, aes(x=sr, y=fit, color="Random 7")) +
  
  #random 8
  geom_point(data=stackRas_list$stackRas_random8, aes(x=sr, y=fdr, color="Random 8"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random8, aes(x=sr, y=fit, color="Random 8")) +
  
  #random 9
  geom_point(data=stackRas_list$stackRas_random9, aes(x=sr, y=fdr, color="Random 9"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random9, aes(x=sr, y=fit, color="Random 9")) +
  
  #random 10
  geom_point(data=stackRas_list$stackRas_random10, aes(x=sr, y=fdr, color="Random 10"), alpha=0.06) +
  geom_smooth(data=pred_data_list$pred_data_random10, aes(x=sr, y=fit, color="Random 10")) +
  
  #within_clusters
  geom_point(data=stackRas_clusters, aes(x=sr, y=fdr, color="Within clusters"), alpha=0.06) +
  geom_smooth(data=pred_data_clusters, aes(x=sr, y=fit, color="Within clusters")) +
  
  #PCA
  geom_point(data=stackRas_PCA, aes(x=sr, y=fdr, color="PCA"), alpha=0.06) +
  ...
  scale_color_manual(
    ...
    name = "Dataset") +
  coord_cartesian(expand=FALSE, xlim=c(0,NA), ylim=c(1,NA)) +
  theme_bw() +
  theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank(), legend.position="bottom",
        axis.line=element_line(size=1.5, linewidth ="solid"), axis.text=element_text(color="black",size=15.3),
        axis.ticks=element_line(size=1.5), axis.ticks.length = unit(.15, "cm")) + #, legend.key=element_rect(fill="white", colour="black")
  labs(x="Taxonomic diversity SR") #+ 
  #ggtitle("Trees AF - Functional Richness ~ SR") #(0:0)
...
#all - no subset, (not (0;0) at the origin/(0;0) at the origin)
g <- ggplot()+
  #eco_based
  geom_point(data=stackRas, aes(x=sr, y=raoq, color="Ecologically based"), alpha=0.05) +
  geom_smooth(data=pred_data_raoq, aes(x=sr, y=fit, color="Ecologically based")) +
  
  #random 1
  geom_point(data=stackRas_list$stackRas_random_raoq1, aes(x=sr, y=raoq, color="Random 1"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq1, aes(x=sr, y=fit, color="Random 1")) +
  
  #random 2
  geom_point(data=stackRas_list$stackRas_random_raoq2, aes(x=sr, y=raoq, color="Random 2"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq2, aes(x=sr, y=fit, color="Random 2")) +
  
  #random 3
  geom_point(data=stackRas_list$stackRas_random_raoq3, aes(x=sr, y=raoq, color="Random 3"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq3, aes(x=sr, y=fit, color="Random 3")) +
  
  #random 4
  geom_point(data=stackRas_list$stackRas_random_raoq4, aes(x=sr, y=raoq, color="Random 4"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq4, aes(x=sr, y=fit, color="Random 4")) +
  
  #random 5
  geom_point(data=stackRas_list$stackRas_random_raoq5, aes(x=sr, y=raoq, color="Random 5"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq5, aes(x=sr, y=fit, color="Random 5")) +
  
  #random 6
  geom_point(data=stackRas_list$stackRas_random_raoq6, aes(x=sr, y=raoq, color="Random 6"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq6, aes(x=sr, y=fit, color="Random 6")) +
  
  #random 7
  geom_point(data=stackRas_list$stackRas_random_raoq7, aes(x=sr, y=raoq, color="Random 7"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq7, aes(x=sr, y=fit, color="Random 7")) +
  
  #random 8
  geom_point(data=stackRas_list$stackRas_random_raoq8, aes(x=sr, y=raoq, color="Random 8"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq8, aes(x=sr, y=fit, color="Random 8")) +
  
  #random 9
  geom_point(data=stackRas_list$stackRas_random_raoq9, aes(x=sr, y=raoq, color="Random 9"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq9, aes(x=sr, y=fit, color="Random 9")) +
  
  #random 10
  geom_point(data=stackRas_list$stackRas_random_raoq10, aes(x=sr, y=raoq, color="Random 10"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq10, aes(x=sr, y=fit, color="Random 10")) +
  
  #within_clusters
  geom_point(data=stackRas_clusters, aes(x=sr, y=raoq, color="Within clusters"), alpha=0.05) +
  geom_smooth(data=pred_data_clusters_raoq, aes(x=sr, y=fit, color="Within clusters")) +
  
  #PCA
  geom_point(data=stackRas_PCA, aes(x=sr, y=raoq, color="PCA"), alpha=0.05) +
...
AIC(m1_eco_based_gam_raoq_fd,m2_eco_based_gam_raoq_fd , m3_eco_based_gam_raoq_fd ,m4_eco_based_gam_raoq_fd ,m5_eco_based_gam_raoq_fd)
#best 2,3, 4
model_p_raoq_fd<-predict(m2_eco_based_gam_raoq_fd, se.fit=TRUE)
...
#m2, m3 or m4
model_p_cluster_raoq_fd<-predict(m2_cluster_gam_raoq_fd, se.fit=TRUE)
...
g <- ggplot()+
  #eco_based
  geom_point(data=stackRas, aes(x=fdr, y=raoq, color="Ecologically based"), alpha=0.05) +
  geom_smooth(data=pred_data_raoq_fd, aes(x=fdr, y=fit, color="Ecologically based")) +
  
  #random 1
  geom_point(data=stackRas_list$stackRas_random_raoq_fd1, aes(x=fdr, y=raoq, color="Random 1"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd1, aes(x=fdr, y=fit, color="Random 1")) +
  
  #random 2
  geom_point(data=stackRas_list$stackRas_random_raoq_fd2, aes(x=fdr, y=raoq, color="Random 2"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd2, aes(x=fdr, y=fit, color="Random 2")) +
  
  #random 3
  geom_point(data=stackRas_list$stackRas_random_raoq_fd3, aes(x=fdr, y=raoq, color="Random 3"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd3, aes(x=fdr, y=fit, color="Random 3")) +
  
  #random 4
  geom_point(data=stackRas_list$stackRas_random_raoq_fd4, aes(x=fdr, y=raoq, color="Random 4"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd4, aes(x=fdr, y=fit, color="Random 4")) +
  
  #random 5
  geom_point(data=stackRas_list$stackRas_random_raoq_fd5, aes(x=fdr, y=raoq, color="Random 5"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd5, aes(x=fdr, y=fit, color="Random 5")) +
  
  #random 6
  geom_point(data=stackRas_list$stackRas_random_raoq_fd6, aes(x=fdr, y=raoq, color="Random 6"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd6, aes(x=fdr, y=fit, color="Random 6")) +
  
  #random 7
  geom_point(data=stackRas_list$stackRas_random_raoq_fd7, aes(x=fdr, y=raoq, color="Random 7"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd7, aes(x=fdr, y=fit, color="Random 7")) +
  
  #random 8
  geom_point(data=stackRas_list$stackRas_random_raoq_fd8, aes(x=fdr, y=raoq, color="Random 8"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd8, aes(x=fdr, y=fit, color="Random 8")) +
  
  #random 9
  geom_point(data=stackRas_list$stackRas_random_raoq_fd9, aes(x=fdr, y=raoq, color="Random 9"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd9, aes(x=fdr, y=fit, color="Random 9")) +
  
  #random 10
  geom_point(data=stackRas_list$stackRas_random_raoq_fd10, aes(x=fdr, y=raoq, color="Random 10"), alpha=0.05) +
  geom_smooth(data=pred_data_list$pred_data_random_raoq_fd10, aes(x=fdr, y=fit, color="Random 10")) +
  
  #within_clusters
  geom_point(data=stackRas_clusters, aes(x=fdr, y=raoq, color="Within clusters"), alpha=0.05) +
  geom_smooth(data=pred_data_clusters_raoq_fd, aes(x=fdr, y=fit, color="Within clusters")) +
  
  #PCA
  geom_point(data=stackRas_PCA, aes(x=fdr, y=raoq, color="PCA"), alpha=0.05) +
  ...
  theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank(), legend.position="bottom",
        axis.line=element_line(size=1.5, linewidth ="solid"), axis.text=element_text(color="black",size=15.3),
        axis.ticks=element_line(size=1.5), axis.ticks.length = unit(.15, "cm"))+ #, legend.key=element_rect(fill="white", colour="black")
  labs(x="Functional Richness (fdr - FDR)") #+
  #ggtitle("Trees AF - RaoQ ~ FDR") #(0:0) 
